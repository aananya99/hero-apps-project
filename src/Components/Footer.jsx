...
const Footer = () => {
    return (
        <footer className="footer sm:footer-horizontal bg-base-300 text-base-content p-5 flex justify-around items-center">
      ...
      <nav>
        <h6 className="text-transparent bg-clip-text bg-linear-to-r from-[#632EE3] to-[#9F62F2] font-bold underline text-lg">Company</h6>
